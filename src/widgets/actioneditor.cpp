...
QString ActionEditor::getDescriptiveName(const QAction *action)
{
    QHash<QString, QString> nameToDescription = {
        ...
        { "actionDecreaseSubtitlesDelay",  tr("Decrease Subtitles Delay") },
        { "actionIncreaseSubtitlesDelay",  tr("Increase Subtitles Delay") },
        { "actionDecreaseAudioDelay",      tr("Decrease Audio Delay") },
        { "actionIncreaseAudioDelay",      tr("Increase Audio Delay") },
